		...
		<div className="flex justify-center w-full bg-custom-primary">
			<div className="max-w-screen-xl text-left text-white lg:flex p-auto">
				<div className="p-4 font-medium lg:w-1/2">
					<h1 className="text-4xl md:text-5xl xl:text-7xl">Hotel, car & experiences</h1>
					...
					<button className="px-4 py-3 mt-8 text-sm font-medium md:px-6 md:text-base rounded-3xl bg-custom-button-accent">Start your search</button>
				</div>
